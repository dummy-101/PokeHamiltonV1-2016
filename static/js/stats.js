    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data.spawn_history, function (count, id) {
                if (id.count > 10) {
                    $('ul[name=spawnpointnest]').append('<li style="float: left; list-style: none; height: 36px; margin-bottom: 30px; margin-right: 5px;"><i class="pokemon-sprite n' + id.pokemon_id + '"></i><span style="font-weight: bold;">   Spawned ' + id.count + ' Times</span></li><br>') &
